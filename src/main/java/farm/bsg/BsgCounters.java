...
public class BsgCounters {
    ...
    public final Counter       auth_attempt_token;

    public final Counter       auth_token_found;
    public final Counter       auth_token_notfound;
    // Section{DATA: TASKS}
    ...
    public BsgCounters(final CounterSource src) {
        ...
        this.auth_attempt_token = src.counter("auth_attempt_token", "an auth was attempted by token");
        this.auth_token_found = src.counter("auth_token_found", "a token for  device auth was found");
        this.auth_token_notfound = src.counter("auth_token_notfound", "a token for device auth was not found");
